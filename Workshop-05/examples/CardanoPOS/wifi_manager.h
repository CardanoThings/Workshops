 ...
 * It handles connection setup, automatic reconnection, and provides status
 ...
 *
 * Monitors the WiFi connection and automatically attempts to reconnect
 * if disconnected. Call this repeatedly in loop() to maintain connection.
 */
